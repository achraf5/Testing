...
public class ReadExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		String path = "C:\\Users\\abousselhami\\Desktop\\fichierxcel\\Test_Shortcut.xlsx";
		String output = objExcelFile.readFromExcel("ExportExcel.xlsx", "Feuil1", path, 1, 1);
		System.out.println("ffff "+output);
